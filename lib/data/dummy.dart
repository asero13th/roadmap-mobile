...
import 'package:roadmap/model/image_obj.dart';
import 'package:roadmap/model/inbox.dart';
import 'package:roadmap/model/model_image.dart';
import 'package:roadmap/model/music_album.dart';
import 'package:roadmap/model/music_song.dart';
import 'package:roadmap/model/news.dart';
import 'package:roadmap/model/people.dart';
import 'package:roadmap/model/photo_info.dart';
import 'package:roadmap/model/review.dart';
import 'package:roadmap/model/shop_category.dart';
import 'package:roadmap/model/shop_product.dart';
import 'package:roadmap/model/wizard.dart';
...
class Dummy {
  ...
  static List<String> lessons = json.decode(
      "[{\"lessonNumber\":1,\"title\":\"Introduction to Machine Learning\",\"content\":\"Understanding the fundamentals of Machine Learning, its types, applications, and the role of Python.\",\"duration\":30,\"videoLink\":\"https://www.youtube.com/watch?v=v_M-qXTk_EE\",\"detailExplanation\":\"This lesson covers the definition of Machine Learning, supervised vs. unsupervised learning, types of Machine Learning problems (regression, classification, clustering), and the importance of Python in Machine Learning.\",\"resource\":[\"https://www.coursera.org/learn/machine-learning\",\"https://developers.google.com/machine-learning/crash-course/\"]},{\"lessonNumber\":2,\"title\":\"Python Fundamentals for Machine Learning\",\"content\":\"Essential Python programming concepts, data structures, and libraries for Machine Learning.\",\"duration\":45,\"videoLink\":\"https://www.youtube.com/watch?v=rfscVS0vfhg\",\"detailExplanation\":\"This lesson covers Python syntax, data types, control flow, functions, modules, NumPy arrays, Pandas DataFrames, and Matplotlib for data visualization.\",\"resource\":[\"https://www.w3schools.com/python/\",\"https://realpython.com/python-data-structures/\",\"https://jakevdp.github.io/PythonDataScienceHandbook/\"]},{\"lessonNumber\":3,\"title\":\"Data Preprocessing and Feature Engineering\",\"content\":\"Preparing data for Machine Learning models, including cleaning, transforming, and selecting features.\",\"duration\":60,\"videoLink\":\"https://www.youtube.com/watch?v=j-3_X-6L4PQ\",\"detailExplanation\":\"This lesson covers data cleaning (handling missing values, outliers, duplicates), data transformation (scaling, normalization, encoding), feature selection (univariate, multivariate methods), and feature engineering.\",\"resource\":[\"https://scikit-learn.org/stable/modules/preprocessing.html\",\"https://www.kaggle.com/learn/feature-engineering\"]},{\"lessonNumber\":4,\"title\":\"Supervised Learning: Regression\",\"content\":\"Linear regression, polynomial regression, and other techniques for predicting continuous values.\",\"duration\":60,\"videoLink\":\"https://www.youtube.com/watch?v=J_LnPL3-0-w\",\"detailExplanation\":\"This lesson covers the principles of linear regression, multiple linear regression, polynomial regression, evaluating regression models (R-squared, MSE), and building regression models using scikit-learn.\",\"resource\":[\"https://towardsdatascience.com/linear-regression-in-python-a-complete-guide-for-beginners-39054ff08c33\",\"https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.LinearRegression.html\"]},{\"lessonNumber\":5,\"title\":\"Supervised Learning: Classification\",\"content\":\"Logistic regression, decision trees, support vector machines, and other techniques for predicting categorical values.\",\"duration\":60,\"videoLink\":\"https://www.youtube.com/watch?v=yX8KuY49Y-o\",\"detailExplanation\":\"This lesson covers logistic regression, decision trees, random forests, support vector machines, evaluating classification models (accuracy, precision, recall, F1-score), and building classification models using scikit-learn.\",\"resource\":[\"https://towardsdatascience.com/logistic-regression-in-python-a-complete-guide-for-beginners-39054ff08c33\",\"https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.LogisticRegression.html\",\"https://scikit-learn.org/stable/modules/tree.html\"]},{\"lessonNumber\":6,\"title\":\"Unsupervised Learning: Clustering\",\"content\":\"K-means clustering, hierarchical clustering, and other techniques for grouping data points based on similarity.\",\"duration\":60,\"videoLink\":\"https://www.youtube.com/watch?v=4b5d3muPQ70\",\"detailExplanation\":\"This lesson covers the concept of clustering, K-means algorithm, hierarchical clustering, evaluating clustering models (silhouette score), and performing clustering using scikit-learn.\",\"resource\":[\"https://towardsdatascience.com/understanding-k-means-clustering-in-machine-learning-6a6e12688d9d\",\"https://scikit-learn.org/stable/modules/clustering.html\"]},{\"lessonNumber\":7,\"title\":\"Model Evaluation and Selection\",\"content\":\"Evaluating the performance of Machine Learning models, choosing the best model for a given task.\",\"duration\":45,\"videoLink\":\"https://www.youtube.com/watch?v=8xfqP7q-Wq4\",\"detailExplanation\":\"This lesson covers various evaluation metrics, cross-validation techniques, hyperparameter tuning, and model selection strategies.\",\"resource\":[\"https://scikit-learn.org/stable/modules/model_evaluation.html\",\"https://machinelearningmastery.com/model-evaluation-and-selection-for-machine-learning/\"]},{\"lessonNumber\":8,\"title\":\"Deep Learning with TensorFlow and Keras\",\"content\":\"Introduction to deep learning, building neural networks with TensorFlow and Keras.\",\"duration\":60,\"videoLink\":\"https://www.youtube.com/watch?v=t-8f4rYq580\",\"detailExplanation\":\"This lesson introduces the concepts of neural networks, convolutional neural networks, recurrent neural networks, and building deep learning models with TensorFlow and Keras.\",\"resource\":[\"https://www.tensorflow.org/tutorials\",\"https://keras.io/\"]},{\"lessonNumber\":9,\"title\":\"Natural Language Processing (NLP) with Python\",\"content\":\"Working with text data, text classification, sentiment analysis, and other NLP tasks.\",\"duration\":60,\"videoLink\":\"https://www.youtube.com/watch?v=2A1zY5u-bgs\",\"detailExplanation\":\"This lesson covers basic NLP concepts, text preprocessing, tokenization, stemming, lemmatization, sentiment analysis, building NLP models using libraries like NLTK and spaCy.\",\"resource\":[\"https://www.nltk.org/\",\"https://spacy.io/\"]},{\"lessonNumber\":10,\"title\":\"Machine Learning Projects and Case Studies\",\"content\":\"Applying Machine Learning techniques to real-world problems, building projects from start to finish.\",\"duration\":60,\"videoLink\":\"https://www.youtube.com/watch?v=H4s-A4yJ304\",\"detailExplanation\":\"This lesson provides guidance on selecting Machine Learning projects, data collection, data cleaning, model building, evaluation, deployment, and showcases examples of successful Machine Learning projects.\",\"resource\":[\"https://www.kaggle.com/datasets\",\"https://github.com/topics/machine-learning-projects\"]}]");
}
